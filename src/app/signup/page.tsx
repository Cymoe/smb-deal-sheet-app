...
export default function SignUpPage() {
  ...
  const handleGoogleSignUp = async () => {
    ...
    let authRedirectUrl = `${window.location.origin}/auth/callback`
    ...
    if (window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1') {
      ...
      authRedirectUrl = `${prodUrl}/auth/callback?from_local=true&local_origin=${encodeURIComponent(window.location.origin)}`
    }
